...
**If you're looking for more information about the compiler options in a tsconfig, check out the  [TSConfig reference](/project-config/tsconfig#tsconfig-reference)**
...
- Every option is fully explained in the  [TSConfig reference](/project-config/tsconfig#tsconfig-reference).
