import{_ as s,o as n,c as a,V as l}from"./chunks/framework.ced88878.js";const m=JSON.parse('{"title":"module-class.d.ts","description":"","frontmatter":{},"headers":[],"relativePath":"en/declaration-files/templates/module-class.md","lastUpdated":1682670826000}'),p={name:"en/declaration-files/templates/module-class.md"},e=l(`<h1 id="module-class-d-ts" tabindex="-1">module-class.d.ts <a class="header-anchor" href="#module-class-d-ts" aria-label="Permalink to &quot;module-class.d.ts&quot;">​</a></h1><p>For example, when you want to work with JavaScript code which looks like:</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki dracula-soft vp-code-dark"><code><span class="line"><span style="color:#F286C4;">const</span><span style="color:#F6F6F4;"> Greeter </span><span style="color:#F286C4;">=</span><span style="color:#F6F6F4;"> </span><span style="color:#62E884;">require</span><span style="color:#F6F6F4;">(</span><span style="color:#DEE492;">&quot;</span><span style="color:#E7EE98;">super-greeter</span><span style="color:#DEE492;">&quot;</span><span style="color:#F6F6F4;">);</span></span>
...
<span class="line"><span style="color:#7B7F8B;"> */</span></span>
<span class="line"><span style="color:#F286C4;">export</span><span style="color:#F6F6F4;"> as namespace </span><span style="color:#DEE492;">&quot;</span><span style="color:#E7EE98;">super-greeter</span><span style="color:#DEE492;">&quot;</span><span style="color:#F6F6F4;">;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#F286C4;">declare</span><span style="color:#F6F6F4;"> </span><span style="color:#F286C4;">class</span><span style="color:#F6F6F4;"> </span><span style="color:#97E1F1;">Greeter</span><span style="color:#F6F6F4;"> {</span></span>
...
<span class="line"><span style="color:#6A737D;"> */</span></span>
<span class="line"><span style="color:#D73A49;">export</span><span style="color:#24292E;"> as namespace </span><span style="color:#032F62;">&quot;super-greeter&quot;</span><span style="color:#24292E;">;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,5),o=[e];function t(c,r,i,y,F,d){return n(),a("div",null,o)}const E=s(p,[["render",t]]);export{m as __pageData,E as default};
