...
We mentioned these briefly in  <a href="/handbooks/handbook-v2/Basics">the Basic Types section</a> .
...
From TypeScript 3.7 and onwards, you can use  <a href="/release-notes/TypeScript[3.7]#optional-chaining">optional chaining</a>  to simplify working with nullable types.
...
TypeScript adds several predefined conditional types, you can find the full list and examples in  <a href="/reference/Utility Types">Utility Types</a> .
