import{_ as s,o as a,c as n,V as e}from"./chunks/framework.ced88878.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{"display":"List Files","oneline":"Print all of the files read during the compilation."},"headers":[],"relativePath":"en/tsconfig-reference/options/listFiles.md","lastUpdated":1681915487000}'),p={name:"en/tsconfig-reference/options/listFiles.md"},l=e(`<p>Print names of files part of the compilation. This is useful when you are not sure that TypeScript has included a file you expected.</p><p>For example:</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki dracula-soft vp-code-dark"><code><span class="line"><span style="color:#f6f6f4;">example</span></span>
...
<span class="line"><span style="color:#24292e;">path/to/example/index.ts</span></span></code></pre></div><p>Note if using TypeScript 4.2, prefer <a href="#explainFiles"><code>explainFiles</code></a> which offers an explanation of why a file was added too.</p>`,8),o=[l];function t(c,i,r,d,y,f){return a(),n("div",null,o)}const m=s(p,[["render",t]]);export{h as __pageData,m as default};
